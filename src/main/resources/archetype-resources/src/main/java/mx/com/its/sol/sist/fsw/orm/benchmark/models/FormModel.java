...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package mx.com.its.sol.sist.fsw.orm.benchmark.models;
...
public class FormModel {
	...
	@MaskFormat("(${symbol_pound}${symbol_pound}${symbol_pound}) ${symbol_pound}${symbol_pound}${symbol_pound}-${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}")
	private String phone;

	@NumberFormat(pattern="${symbol_dollar}${symbol_pound}${symbol_pound}${symbol_pound},${symbol_pound}${symbol_pound}${symbol_pound}.00")
